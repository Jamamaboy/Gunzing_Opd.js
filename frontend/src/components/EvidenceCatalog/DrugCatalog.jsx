...
const DrugCard = ({ image, title, description }) => {
  return (
    <div className="bg-white rounded-lg shadow-sm p-3 flex flex-col items-center hover:shadow-md transition-shadow h-[280px] max-w-[210px] mx-auto w-full">
      ...
      <div className="w-full flex-1 flex flex-col">
        <h3 className="font-semibold text-base mb-2 text-left line-clamp-2">{title}</h3>
        <p className="text-gray-600 text-sm text-left line-clamp-3">{description}</p>
      </div>
    </div>
  );
};
...
const DrugCatalog = () => {
    ...
    const drugs = [
        ...
        {
          id: 4,
          image: "./Img/ยาเสพติด/หีบห่อ/999_red.png",
        ...
        {
          id: 5,
          image: "./Img/ยาเสพติด/หีบห่อ/999_blue.png",
        ...
        {
            id: 6,
            image: "./Img/ยาเสพติด/หีบห่อ/Chelsea Football Club.png",
            title: "เชลซี",
        ...
        {
            id: 7,
            image: "./Img/ยาเสพติด/หีบห่อ/Apple 999.png",
            title: "Apple 999",
        ...
        {
            id: 8,
            image: "./Img/ยาเสพติด/หีบห่อ/ลิเวอร์พูล.png",
            title: "ลิเวอร์พูล",
            description: "ประเภท: โคเคน",
            type: "โคเคน"
        },
        {
            id: 9,
            image: "./Img/ยาเสพติด/หีบห่อ/Double Uoglobe Brand.png",
        ...
        {
            id: 10,
            image: "./Img/ยาเสพติด/หีบห่อ/999_หลุยส์วิตตอง.png",
        ...
        {
            id: 11,
            image: "./Img/ยาเสพติด/หีบห่อ/Manchester United.png",
            title: "แมนยู",
        ...
        {
            id: 12,
            image: "./Img/ยาเสพติด/หีบห่อ/Lexus_AAA_5Star.png",
        ...
        {
            id: 13,
            image: "./Img/ยาเสพติด/หีบห่อ/กัญชา.png",
            title: "กัญชา",
            description: "ประเภท: เคตามีน",
            type: "เคตามีน"
        },
        {
            id: 14,
            image: "./Img/ยาเสพติด/หีบห่อ/A 1ดาว.png",
            title: "A 1 ดาว",
            description: "ประเภท: เคตามีน",
            type: "เคตามีน"
        },
        {
            id: 15,
            image: "./Img/ยาเสพติด/หีบห่อ/999_Rolex.png",
            title: "999 Rolex",
            description: "ประเภท: ยาบ้า",
            type: "ยาบ้า"
        },
        {
            id: 16,
            image: "./Img/ยาเสพติด/หีบห่อ/Y1-Real Madrid-Red.png",
