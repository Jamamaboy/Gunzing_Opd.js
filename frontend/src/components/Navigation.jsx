...
import { FiMenu, FiMoreHorizontal, FiChevronDown, FiChevronUp } from 'react-icons/fi';
import { FaHome, FaCamera, FaUpload, FaImage, FaFolder } from "react-icons/fa";
...
const Navigation = () => {
  ...
  const uploadDropdownItems = [
    { id: 'upload-gun', icon: <FaImage size={24} />, text: "อาวุธปืน", path: "/upload/photo", mode: "อาวุปืน" },
    { id: 'upload-drug', icon: <FaFolder size={24} />, text: "ยาเสพติด", path: "/upload/album", mode: "ยาเสพติด" },
  ];
