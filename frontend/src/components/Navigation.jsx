...
const Navigation = () => {
  ...
  const menuItems = [
    ...
    { id: 'camera', icon: <FaCamera size={24} />, text: "ถ่ายภาพ", path: "/", showInBottom: true, isSpecial: true },
    { id: 'upload', icon: <FaUpload size={24} />, text: "อัพโหลดภาพ", path: "/", showInBottom: false, hasDropdown: true },
    { id: 'map', icon: <FaMapLocationDot size={24} />, text: "แผนที่", path: "/", showInBottom: true, isSpecial: true },
  ];
        ...
        <div className="relative h-16 px-6">
          <div className="flex justify-between items-center h-full">
            ...
            <div className="flex-1 flex justify-center">
              <button
                onClick={(e) => handleNavClick(e, "/", 'camera')}
