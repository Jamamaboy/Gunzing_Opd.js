      ...
      <div className="fixed bottom-0 left-0 right-0 z-40">
        ...
        <div className="relative h-16 px-4">
          <div className="flex items-center justify-between h-full">
            {/* Home */}
            <button
              onClick={(e) => handleNavClick(e, "/selectCatalogType", 'home')}
              className={`
            ...
            {/* History */}
            <button
              onClick={(e) => handleNavClick(e, "/selectCatalogType", 'history')}
              className={`
                flex flex-col items-center justify-center w-16 h-full
                transition-all duration-200
            ...
            <button
              onClick={(e) => handleNavClick(e, "/selectCatalogType", 'camera')}
            ...
            {/* Map */}
            <button
              onClick={(e) => handleNavClick(e, "/selectCatalogType", 'map')}
              className={`
                flex flex-col items-center justify-center w-16 h-full
                transition-all duration-200
