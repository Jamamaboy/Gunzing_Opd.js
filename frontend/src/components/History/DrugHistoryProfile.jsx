...
const DrugHistoryProfile = ({ item }) => {
  ...
  const handleShare = async () => {
    ...
    const shareTitle = `ยาเสพติด: ${drugData.type}`;
    const shareText = `ผลการวิเคราะห์ยาเสพติด - ประเภท: ${drugData.type}, แหล่งผลิต: ${drugData.brand}, ความมั่นใจ: ${drugData.confidence}%`;
          ...
          <div className="mb-8">
            <div className="flex flex-row">
              ...
              <div className="space-y-4 w-1/2">
                ...
                <div className="flex">
                  <span className="text-gray-600 w-40">กลุ่มยา(G):</span> 
                  <span></span>
                </div>
        ...
        <div className="flex items-start">
          ...
          <div className="flex-1">
            ...
            <div className="py-2 flex">
              <span className="text-gray-600 w-32">กลุ่มยา(G):</span> 
