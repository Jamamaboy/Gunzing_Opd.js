 ...
 * @param {function} onRowsPerPageChange - Function to handle rows per page changes
 * @param {number} totalItems - Total number of items
 * @param {number} indexOfFirstItem - Index of first item on current page
 * @param {number} indexOfLastItem - Index of last item on current page
 */
const Pagination = ({ 
  currentPage, 
  totalPages, 
